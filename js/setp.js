...
function showInputFields1(sexe, age, status, compSize, serv, orgtyp1, orgtyp2, com, mena1, mena2) {
...
showInputFields1("block", "block", "block", "none", "none", "none", "none", "none", "none");
...
userTypeSelect.addEventListener("change", (event) => {
    ...
    switch (selectedOption) {
        case "option1":
            showInputFields1("block", "block", "block", "none", "none", "none", "none", "none", "none", "none");
            break;
        case "option2":
            showInputFields1("none", "none", "none", "block", "none", "none", "none", "none", "none", "none");
            break;
        case "option3":
            showInputFields1("none", "none", "none", "none", "block", "none", "none", "none", "none", "none");
            break;
        case "option4":
            showInputFields1("none", "none", "none", "none", "none", "block", "block", "none", "none", "none");
            break;
		case "option5":
			showInputFields1("none", "none", "none", "none", "none", "none", "none", "block", "none", "none");
			break;
		case "option6":
			showInputFields1("none", "none", "none", "none", "none", "none", "none", "none", "block", "block");
			break;
        default:
...
const actorType = document.getElementById("actor_type_input");
